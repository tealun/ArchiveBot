    ...
    try:
        ...
        if language.startswith('zh'):
            ...
            if is_formal:
                ...
                prompt += "• Output note content directly, no word count or metadata\n\n"
            else:
                ...
                prompt += "• Just the note, no word count or extra explanations\n\n"
            prompt += f"Content:\n{content[:3000]}"
    ...
    try:
        ...
        if language.startswith('zh'):
            ...
            if is_formal:
                ...
                prompt += "• Output note content directly, no word count or annotations\n"
            else:
                ...
                prompt += "• Just give me the note content, no word count\n"
